...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val transPhotoArray =
            intArrayOf(R.drawable.trans1, R.drawable.trans1, R.drawable.trans3, R.drawable.trans4)
        ...
        val messageAdapter =
            ArrayAdapter(this, android.R.layout.simple_expandable_list_item_1, messageArray)
